 ...
 */
final class Version20220921090849 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
